...
export default function Pasatiempos() {
  const hobbies = [
    {
      title: 'Videojuegos',
      description: 'Aficionado a los videojuegos en PC, motivado por la experiencia inmersiva, la narrativa envolvente y la colaboración estratégica en títulos de acción y estrategia.',
    ...
    },
    {
      ...
      description: 'Interés por la música variada; toco guitarra y compongo canciones como medio de expresión creativa. Además, realizo lecturas ocasionales de ciencia ficción y desarrollo personal, orientadas al crecimiento continuo.',
